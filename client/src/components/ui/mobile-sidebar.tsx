...
const MobileSidebar: React.FC<MobileSidebarProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className={`md:hidden fixed inset-0 z-20 transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 ease-in-out`}>
      ...
      <div className="relative flex flex-col w-80 max-w-xs bg-white h-full">
        <div className="flex items-center justify-between h-16 px-4 border-b border-gray-200">
          ...
          <button type="button" className="text-gray-500 focus:outline-none" onClick={onClose}>
